        ...
        if test_file.is_file():
            ...
            for file in files:
                if 'label' not in str(file):
                    ...
                    segmap_overlay = semseg.predict(str(file), True)
                    ...
                    #segmap_no_overlay.save(save_dir / f"{str(file.stem)}_colored.png")
                    segmap_overlay.save(save_dir / f"{str(file.stem)}_overlay.png")
